...
- **OCR Scanner:** Press `Ctrl + V` to paste a screenshot directly into the app and extract text instantly using an offline WebAssembly Tesseract.js neural network.
...
- **Core Engines:** `ffmpeg`, `react-easy-crop`, `pdf-lib`, `tesseract.js`
